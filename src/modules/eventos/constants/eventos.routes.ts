...
export const EVENTOS_ROUTE_SEGMENTS = {
  ...
  REPORTE: 'reporte',
  CERRAR: 'cerrar',
  HABILITAR_MOVIMIENTOS: 'habilitar-movimientos',
  COBRAR: 'cobrar',
  REPORTE_PUBLICO: 'reporte/publico',
  REPORTE_PUBLICO_TOGGLE: 'reporte-publico',
} as const;
...
export const EVENTOS_ROUTES = {
  ...
  VENTA_COBRAR: `:${EVENTOS_PARAM_NAMES.EVENTO_ID}/${EVENTOS_ROUTE_SEGMENTS.VENTAS}/:${EVENTOS_PARAM_NAMES.VENTA_ID}/${EVENTOS_ROUTE_SEGMENTS.COBRAR}`,
  ...
  HABILITAR_MOVIMIENTOS_BY_EVENTO: `:${EVENTOS_PARAM_NAMES.EVENTO_ID}/${EVENTOS_ROUTE_SEGMENTS.HABILITAR_MOVIMIENTOS}`,
  REPORTE_PUBLICO_BY_EVENTO: `:${EVENTOS_PARAM_NAMES.EVENTO_ID}/${EVENTOS_ROUTE_SEGMENTS.REPORTE_PUBLICO}`,
  REPORTE_PUBLICO_TOGGLE_BY_EVENTO: `:${EVENTOS_PARAM_NAMES.EVENTO_ID}/${EVENTOS_ROUTE_SEGMENTS.REPORTE_PUBLICO_TOGGLE}`,
} as const;
